...
import com.logai.mcp.meta.RecordMeta;
import com.logai.mcp.meta.testmeta;
...
public class AssintMcpService {
    ...
    public McpSchema.CallToolResult record(
        ...
        GlobalAiAssintResponse globalAiAssintResponse = assistService.handleRecordIntent(
                user,
                message,
                counter
        );
        ...
        structuredContent.put("entries", globalAiAssintResponse);
