...
public class PaymentController {
    ...
    @PostMapping("/checkout_unauthenticated")
    public Result checkoutUnauthenticated(
            @RequestBody CreateCheckoutRequest request) throws JsonProcessingException {
        return Result.success(paymentService.createCheckoutSession(request, null));
    }
